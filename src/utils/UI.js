...
const getSpeed_1 = require("./getSpeed");
/**
...
const updateUI = (bar, box, screen, fullFilename, destination, written, total, data, isFinished) => {
    let downloaded, remaining, totalInMB = round_1.round(total / 1000000, 2);
...
const buildUI = (fullFilename, destination, total) => {
    ...
    const bar = grid.set(8, 0, 4, 12, blessed_contrib_1.default.gauge, {
        tags: true,
    ...
    const box = grid.set(0, 0, 8, 12, blessed_1.default.box, {
        tags: true,
