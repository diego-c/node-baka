 ...
 *
 */
exports.default = (function (url) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!!(/^https?\:\/\/./.test(url))) return [3 /*break*/, 1];
                throw new ProtocolError('The url must use either the http or the https protocol');
            case 1:
                if (!/^https:\/\/./.test(url)) return [3 /*break*/, 3];
                return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require('https')); })];
            case 2: return [2 /*return*/, _a.sent()];
            case 3: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require('http')); })];
